...
// 11. Write a MongoDB query to find the restaurants that do not prepare any cuisine of 'American' and their grade score more than 70 and latitude less than -65.754168.
        ...
        db.restaurants.find({$and:[{"cuisine":{$ne:'American'}},{"grades.score":{$gt:70}},{"address.coord":{$lt:-65.754168}}]},{_id:1,"name": 1, "borough": 1, "address.zipcode": 1,"restaurant_id": 1, "grades.score": 1 })
        records:9
...
// 18. Write a MongoDB query to find the restaurant Id, name, borough and cuisine for those restaurants which belong to the borough Staten Island or Queens or Bronxor Brooklyn.
        db.restaurants.find({"borough":{$in:["Staten Island","Queens","Brooklyn"]}},{ _id: 1, "name": 1, "borough": 1, "address.zipcode": 1, "restaurant_id": 1, "grades.score": 1 })
        records:1580
        
// 19. Write a MongoDB query to find the restaurant Id, name, borough and cuisine for those restaurants which are not belonging to the borough Staten Island or Queens or Bronxor Brooklyn.
        db.restaurants.find({"borough":{$nin:["Staten Island","Queens","Brooklyn"]}},{ _id: 1, "name": 1, "borough": 1, "address.zipcode": 1, "restaurant_id": 1, "grades.score": 1 })
        records:2192
        
// 20. Write a MongoDB query to find the restaurant Id, name, borough and cuisine for those restaurants which achieved a score which is not more than 10.
        db.restaurants.find({ "grades.score": { $not: { $gt: 10 } } }, { _id: 0, "name": 1, "borough": 1, "cuisine": 1,"restaurant_id": 1 , "grades.score": 1 })
        records:340

// 21. Write a MongoDB query to find the restaurant Id, name, borough and cuisine for those restaurants which prepared dish except 'American' and 'Chinees' or restaurant's name begins with letter 'Wil'.
        db.restaurants.find({ $nor: [{ "name": { $regex: "^Wil" } }, { "cuisine": { $in: ["American", "Chinese"] } }] }, { _id: 1, "name": 1, "borough": 1,"restaurant_id": 1, "cuisine": 1  })        
        records:3654
...
// 23. Write a MongoDB query to find the restaurant Id, name and grades for those restaurants where the 2nd element of grades array contains a grade of "A" and score 9 on an ISODate "2014-08-11T00:00:00Z".
        db.restaurants.find({"grades.date": ISODate("2014-08-11T00:00:00Z"), "grades.grade": "A", "grades.score": 9 },{_id:0, "restaurant_id":1, "name":1, "grades":1})
        records:15

// 24. Write a MongoDB query to find the restaurant Id, name, address and geographical location for those restaurants where 2nd element of coord array contains a value which is more than 42 and upto 52..
        db.restaurants.find({ "address.coord": { $gt: 42, $lte: 52 } },{_id:0, restaurant_id:1, name:1, address:1})
        records:9
...
// 30. Write a MongoDB query which will select the restaurant Id, name and grades for those restaurants which returns 0 as a remainder after dividing the score by 7.
        db.restaurants.find({ "grades.score": { $mod: [7, 0] } },{_id: 1, name: 1, borough: 1, "address.zipcode": 1, restaurant_id: 1})
        records:1585